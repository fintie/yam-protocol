...
mypath = "/Users/nqi/Workspace/yam-protocol/build/contracts"
onlyfiles = [f for f in listdir(mypath) if isfile(join(mypath, f))]
onlyfiles

for file in onlyfiles:
    with open("/Users/nqi/Workspace/yam-protocol/build/contracts/"+file, "r") as f:
        if "json" in file:
            try:
                cleaned = {}
                a = json.loads(f.read())
                ...
                with open("/Users/nqi/Workspace/yam-protocol/clean_build/contracts/"+file, "w+") as c:
