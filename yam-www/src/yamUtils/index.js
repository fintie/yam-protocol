...
export const delegate = async (yam, account) => {
  return yam.contracts.yam.methods.delegate("0xefd6c47768e44b791c9cd1765f9abd12a03b7140").send({from: account, gas: 320000 })
}

export const didDelegate = async (yam, account) => {
  return await yam.contracts.yam.methods.delegates(account).call() === '0xefd6c47768e44b791c9cd1765f9abd12a03b7140'
}

export const getVotes = async (yam) => {
  const votesRaw = new BigNumber(await yam.contracts.yam.methods.getCurrentVotes("0xefd6c47768e44b791c9cd1765f9abd12a03b7140").call()).div(10**24)
  return votesRaw
}
